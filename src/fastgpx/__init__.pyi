...
class TimeBounds:
    ...
    @start_time.setter
    def start_time(self, start_time: datetime.datetime | None) -> None: ...

    @property
    def end_time(self) -> datetime.datetime | None: ...

    @end_time.setter
    def end_time(self, end_time: datetime.datetime | None) -> None: ...
...
class LatLong:
    ...
    @overload
    def __init__(self, latitude: float, longitude: float, elevation: float = 0.0, time: datetime.datetime | None = None) -> None: ...
    ...
    @time.setter
    def time(self, time: datetime.datetime | None) -> None: ...
